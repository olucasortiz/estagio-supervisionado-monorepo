...
public class PaymentRepository {
    ...
    private static final RowMapper<OverdueMemberResponse> OVERDUE_MEMBER_ROW_MAPPER = (resultSet, rowNum) -> new OverdueMemberResponse(
    ...
    public boolean hasPendingOrOverdueByMemberId(UUID memberId) {
        Integer result = jdbcTemplate.queryForObject(
                ...
                where s.member_id = ?
                  ...
                  and (
                      p.status::text in ('PENDING', 'OVERDUE')
