...
export function SheetContent({
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Content drawer */}
      <div
        className={`relative z-50 flex h-full flex-col bg-sidebar shadow-2xl transition-transform duration-300 ease-in-out ${side === "left" ? "animate-in slide-in-from-left" : "animate-in slide-in-from-right ml-auto"
          } ${className}`}
      >
        <button
          onClick={() => context.setOpen(false)}
